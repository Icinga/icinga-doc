...
5.  Seien Sie sich bewusst, woher Sie mehr Informationen bekommen
    ...
    Icinga zu tun, aber dafür umso mehr mit dem Schreiben von
    Perl-Programmen für den eingebetteten Perl-Interpreter in Apache
    (d.h. Doug MacEacherns mod\_perl).
    ...
    Apache Modules with Perl and C' ziemlich sicher einen Blick wert.
...
10. Überlegen Sie, ob Sie ein Mini-ePN benutzen, um Ihr Plugin zu
    ...
    *contrib/*-Verzeichnis der Icinga-Distribution zu finden. Wechseln
    Sie in das contrib/-Verzeichnis und tippen Sie 'make mini\_epn', um
    es zu kompilieren. Es muss im gleichen Verzeichnis ausgeführt
    werden, in dem die p1.pl-Datei steht (diese Datei wird mit Icinga
    ausgeliefert). ]

* * * * *

  --------------------------- -------------------------- ----------------------------------------------
  [Zurück](pluginapi.md)    [Nach oben](ch11.md)      [Weiter](icinga-api.md)
  11.1. Nagios Plugin API     [Zum Anfang](index.md)    11.3. Keine Icinga API mehr zu installieren
  --------------------------- -------------------------- ----------------------------------------------
