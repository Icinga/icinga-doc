...
[Zurück](sample-contacts.md) 

Kapitel 13. Icinga Beispieldateien

 [Weiter](sample-notifications.md)
...
* * * * *
  ...
  --------------------------------- -------------------------- --------------------------------------
  [Zurück](sample-contacts.md)    [Nach oben](ch13.md)      [Weiter](sample-notifications.md)
  13.7. contacts.cfg                [Zum Anfang](index.md)    13.9. notifications.cfg
  --------------------------------- -------------------------- --------------------------------------
